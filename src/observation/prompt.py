...
3. 不得在缺少可靠尺寸参照（路缘石、台阶、井盖、标线、轮胎、交通锥、护栏、砖块等）时编造精确厘米数；此时 depth_cm 全 null、waterlogging_level 用 LX。
4. 只有存在清晰水位线或已知尺寸参照与水面的明确关系时，才填 depth_cm，并优先给区间而非伪精确单值。
